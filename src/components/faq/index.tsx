						...
						<div className="py-5">
							<details className="group">
								...
								<p className="group-open:animate-fadeIn mt-3 text-neutral-600">
									...
									equal to another), NFTs are one-of-a-kind. They&apos;re often
									used to prove ownership of digital assets like art, music,
									videos, collectibles, or even in-game items.
								</p>
							</details>
						</div>
						<div className="py-5">
						...
						<div className="py-5">
							<details className="group">
								...
								<p className="group-open:animate-fadeIn mt-3 text-neutral-600">
									...
									to create. To batch mint, you&apos;ll typically upload a
									folder of your media files (images, videos, etc.) along with a
									metadata file that includes the details for each NFT.
								</p>
							</details>
						</div>
						<div className="py-5">
