...
export type EmailPasswordSigninMutation = {
  __typename?: "Mutation";
  emailPasswordSignin: {
    __typename?: "AuthTokenType";
    id: string;
...
export type EmailPasswordSignupMutation = {
  __typename?: "Mutation";
  emailPasswordSignup: { __typename?: "UserType"; id: string; uuid: string };
};
...
export type CreateUpdateSubscriptionPackageMutation = {
  __typename?: "Mutation";
...
export function useCreateUpdateSubscriptionPackageMutation() {
  return Urql.useMutation<
    CreateUpdateSubscriptionPackageMutation,
    CreateUpdateSubscriptionPackageMutationVariables
  >(CreateUpdateSubscriptionPackageDocument);
}
...
export function useSubscriptionPackagesQuery(
  options?: Omit<
    Urql.UseQueryArgs<SubscriptionPackagesQueryVariables>,
    "query"
  >,
) {
  return Urql.useQuery<
    SubscriptionPackagesQuery,
    SubscriptionPackagesQueryVariables
  >({ query: SubscriptionPackagesDocument, ...options });
}
